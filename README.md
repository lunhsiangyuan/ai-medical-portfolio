...
```
  2025 Q1         2025 Q4            2026 Q1            2026 NOW
  │                │                  │                  │
  ▼                ▼                  ▼                  ▼

  ┌──────────┐  ┌──────────┐  ┌────────────┐  ┌────────────────┐
  │ LLM 醫學  │  │ How I    │  │ Claude Code│  │ 完整 AI        │
  │ 應用研究  │─▶│ Do It    │─▶│ + Agent    │─▶│ 基礎設施       │
  │          │  │          │  │ Teams      │  │                │
  │ 理論探索  │  │ 日常實踐  │  │ 系統化建構  │  │ 60+ Skills     │
  │          │  │ 公開演講  │  │ 多Agent協作 │  │ 跨領域整合     │
  └──────────┘  └──────────┘  └────────────┘  └────────────────┘

  雲嘉季會        新創醫學會       臺大泌尿部        研究/教學/臨床
  LLM 原理 +      「AI 如何融入    10 Agent 協作     /法規/商業
  攝護腺癌應用     泌尿科日常」     研究產能倍增      全面覆蓋
```
