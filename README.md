...
```
  ...
  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌────────────┐  ┌────────────────┐
  │ PhD 博士  │  │ LLM 醫學  │  │ How I    │  │ Claude Code│  │ 完整 AI        │
  │ 論文研究  │─▶│ 應用研究  │─▶│ Do It    │─▶│ + Agent    │─▶│ 基礎設施       │
  │          │  │          │  │          │  │ Teams      │  │                │
  │ AI × 臨床 │  │ 理論探索  │  │ 日常實踐  │  │ 系統化建構  │  │ 60+ Skills     │
  │ 醫學應用  │  │          │  │ 公開演講  │  │ 多Agent協作 │  │ 跨領域整合     │
  └──────────┘  └──────────┘  └──────────┘  └────────────┘  └────────────────┘

  成功大學          雲嘉季會        新創醫學會       臺大泌尿部        研究/教學/臨床
  醫學工程博士      LLM 原理 +      「AI 如何融入    10 Agent 協作     /法規/商業
  AI 臨床醫學應用   攝護腺癌應用     泌尿科日常」     研究產能倍增      全面覆蓋
```

### 2020–2025 — 博士研究：AI 與臨床醫學的交會

在國立成功大學醫學工程研究所攻讀博士，論文主題為「AI 在臨床醫學上的應用」。五年的研究歷程奠定了 AI 與醫學交叉領域的理論基礎與實作能力，為後續建構完整 AI 基礎設施埋下種子。

### 2025 — 從理論到實踐

在雲嘉泌尿科季會發表 [LLM 在醫學上的應用](slides/LLM在醫學上的應用.pdf)，探討 Transformer 原理與攝護腺癌臨床應用。隨後將 AI 導入日常工作：門診筆記自動化、PubMed 智能搜尋、文獻整理。同年在新創醫學會發表 [LLM - How I Do It](slides/新創醫學會-LLM-How-I-Do-It.pptx)，分享實際臨床應用經驗。

### 2026 — 從工具到系統

導入 Claude Code 後，建構了多 Agent 協作系統。在[臺大泌尿部晨會](slides/ai-agent-research-talk-final.pptx)展示成果：一位研究者搭配 10 個 AI Agent，產出等同完整研究團隊。同時將 AI 擴展至美國醫療法規研究（NYSED 醫師執照、O-1A 簽證、FTC 合併法規），建立 48 筆先例資料庫。
